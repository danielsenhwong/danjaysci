"""
Django settings for danjaysci project.
...
WSGI_APPLICATION = 'danjaysci.wsgi.application'
...
STATIC_ROOT = '/var/www/danjaysci.com/danjaysci/danjaysci/public/static/'
STATIC_URL = '/static/'
